# Tweet-Sentiment-Analysis-Mini-Project
A Python mini project to classify tweets related to Data Science into Positive and Negative sentiments using TextBlob, with data cleaning, visualization.
Include:
